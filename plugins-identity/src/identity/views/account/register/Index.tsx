...
import { REGISTER_SERVICE } from '@plugins-identity/identity/services.ts';
import { REGISTER_SUCCESSFUL_URL } from '@plugins-identity/identity/urls.ts';
import { TOS_URL, PRIVACY_POLICY_URL } from '@plugins-identity/keys.ts';
